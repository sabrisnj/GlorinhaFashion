      ...
      <header className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <span className="text-[10px] font-bold uppercase leading-tight">Check-in na Loja<br/>(ganhe descontos)</span>
          </Link>
        </div>
        ...
        <div className="pt-2">
          <a 
            ...
            className="flex items-center justify-center p-3 bg-gray-100 text-ink rounded-xl text-center gap-2 hover:bg-gray-200 transition-colors"
          >
            <ShoppingBag size={16} className="text-primary" />
            <span className="text-[10px] font-bold uppercase">Divulgue seu produto ou serviço</span>
          </a>
        </div>
      </header>

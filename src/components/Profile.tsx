...
import { User, LogOut, Bell, History, Ticket, Star, Share2, Type, Eye, Layout, Volume2, ChevronDown, ChevronUp, Shield, HelpCircle, BookOpen, Smartphone, UserPlus, Calendar as CalendarIcon, ShoppingBag, Gift, CheckCircle, Accessibility } from 'lucide-react';
      ...
      <div className="space-y-3">
        ...
        >
          <div className="space-y-4">
            ...
            <GuideItem title="Check-in na Loja" icon={CheckCircle}>
              <div className="space-y-2 text-sm text-gray-custom">
